      ...
      <div className="max-w-md w-full mx-auto bg-white p-8 rounded-xl shadow-sm border border-stone-100">
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-4">
          ...
          <div className="w-full flex justify-center">
            {googleLoading ? (
            ...
            ) : import.meta.env.VITE_GOOGLE_CLIENT_ID && !import.meta.env.VITE_GOOGLE_CLIENT_ID.includes("your_google_oauth") ? (
              <GoogleLogin
              ...
              <div className="w-full text-center text-xs text-stone-500 bg-stone-50 border border-stone-200 rounded-md py-2.5 px-3">
                ⚠️ Google Sign-In requires your <strong>Google Client ID</strong> in <code className="text-stone-700 bg-stone-200 px-1 py-0.5 rounded">web/.env</code>
              </div>
            )}
          </div>
        </form>
