    ...
    <footer className="bg-white border-t border-stone-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] tracking-[0.2em] font-extrabold text-stone-500 uppercase">
                  Butcher House
                </span>
              </div>
            </div>
            <p className="text-stone-600 max-w-sm mb-4 leading-relaxed text-sm">
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-red-50 border border-red-200 text-primary text-xs font-bold mb-6">
              <span>★ Premium Cuts • Quality You Can Trust ★</span>
            </div>
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" className="text-stone-400 hover:text-primary transition-colors">
                <span className="sr-only">Instagram</span>
                <InstagramIcon className="w-6 h-6" />
              </a>
              <a href="https://www.tiktok.com/" target="_blank" rel="noopener noreferrer" className="text-stone-400 hover:text-primary transition-colors">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-bold text-black mb-4 uppercase tracking-wider text-sm">Fresh Meat Cuts</h3>
          ...
          <div>
            ...
            <ul className="space-y-4 text-stone-600 text-sm font-medium">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:9865311559" className="hover:text-primary transition-colors font-bold">+977 9865311559</a>
              </li>
        ...
        <div className="border-t border-stone-200 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-stone-500">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            ...
            <Link to="/admin/login" className="hover:text-primary transition-colors text-stone-400" title="Admin Login">
